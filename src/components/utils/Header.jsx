...
import "./Header.css"
import tube_logo from "./tube_logo.png"
...
const Header = () => {
  ...
  return (
    <header className="bg-gray-800 shadow-md sticky top-0 z-50 ">
        <div className="title">
          <img src={tube_logo} className="logo"/>
          <Link to="/home" className="text-white text-6xl font-bold font-title">
            Movilo
          </Link>
          </div>
      <nav className="h-[10vh] container mx-auto 2xl:xl:md:flex  items-center justify-center p-4">
          <div>
            <button
              onClick={toggleMenu}
        ...
        >
          <Link
            to="/home"
            className="text-gray-300 hover:text-white  mx-5 "
          >
            Popular
          </Link>
          <Link
